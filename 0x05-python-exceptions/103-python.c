...
/**
 * print_python_float - this prints information about python float
...
/**
 * print_python_bytes - this prints information about python bytes
 * @p: The address of pyobject struct
 */
...
/**
 * print_python_list - this prints information about python lists
 * @p: The address of pyobject struct
 */
