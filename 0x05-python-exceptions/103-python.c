...
/**
 * print_python_float - This function prints information about python float
...
void print_python_float(PyObject *p)
{
	...
	d = ((PyFloatObject *)p)->obfval;
	printf("  value: %s\n",
		PyOS_double_to_string(d, 'r', 0, Py_DTSF_ADD_DOT_0, NULL));
}

/**
 * print_python_bytes - This function prints information about python bytes
 * @p: The address of pyobject struct
 */
...
/**
 * print_python_list - This function prints information about python lists
 * @p: The address of pyobject struct
 */
